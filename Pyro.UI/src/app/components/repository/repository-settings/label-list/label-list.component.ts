import { disableLabel, enableLabel, loadLabels } from '@actions/repository.actions';
...
import { labelsSelector } from '@states/repository.state';
...
export class LabelListComponent implements OnInit {
    ...
    public labels$: Observable<DataSourceState<Label>> = this.store.select(labelsSelector);
