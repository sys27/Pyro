...
import { selectedUserSelector } from '@states/users.state';
...
export class UserEditComponent implements OnInit {
    ...
    public roles$: Observable<DataSourceState<Role>> = this.store.select(rolesFeatureSelector);
